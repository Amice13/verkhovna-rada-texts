...
const START_URL = 'https://kompek.rada.gov.ua'
const TRANSCRIPT_URL = `${START_URL}/news/dijalnist9skl/zasid_kom9skl/stenogr9skl`

const NAME = 'Комітет з питань енергетики та житлово-комунальних послуг'
const TARGET_PATH = ['.', 'results', 'kompek']

...
const START_URL = 'https://reglament.rada.gov.ua'
const TRANSCRIPT_URL = `${START_URL}/documents/stenogr_z`

const NAME = 'Комітет з питань Регламенту, депутатської етики та організації роботи Верховної Ради України'
const TARGET_PATH = ['.', 'results', 'reglament']

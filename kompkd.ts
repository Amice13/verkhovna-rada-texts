...
const START_URL = 'https://kompkd.rada.gov.ua'
const TRANSCRIPT_URL = `${START_URL}/news/Zasidan_Komitet/Stenogramy_zasidan_Komitet`

const NAME = 'Комітет з питань гуманітарної та інформаційної політики'
const TARGET_PATH = ['.', 'results', 'kompkd']

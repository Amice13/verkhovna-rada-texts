...
const START_URL = 'https://kompravlud.rada.gov.ua'
const TRANSCRIPT_URL = `${START_URL}/news/dijaln_komit/stenogr`

const NAME = 'Комітет з питань прав людини, деокупації та реінтеграції тимчасово окупованих територій України, національних меншин і міжнаціональних відносин'
const TARGET_PATH = ['.', 'results', 'kompravlud']

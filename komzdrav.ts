...
const START_URL = 'https://komzdrav.rada.gov.ua'
const TRANSCRIPT_URL = `${START_URL}/news/ZasidKom9skl/Stenograms9skl`

const NAME = 'Комітет з питань здоров\'я нації, медичної допомоги та медичного страхування'
const TARGET_PATH = ['.', 'results', 'komzdrav']

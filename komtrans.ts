...
const START_URL = 'https://komtrans.rada.gov.ua'
const TRANSCRIPT_URL = `${START_URL}/news/Diyalnist_komitetu_9skl/Stenogramy_zasidan_komitetu_9skl`
...
const TARGET_PATH = ['.', 'results', 'komtrans']

...
const NAME = 'Комітет з питань зовнішньої політики та міжпарламентського співробітництва'
const START_URL = 'https://komzak.rada.gov.ua/news/Zasidaniy_komit/Stenogramy'
const TARGET_PATH = ['.', 'results', 'komzak']

...
const START_URL = 'https://komsport.rada.gov.ua'
const TRANSCRIPT_URL = `${START_URL}/news/dijaln_komit/zasid_komit/stenogramy`

const NAME = 'Комітет з питань молоді і спорту'
const TARGET_PATH = ['.', 'results', 'komsport']

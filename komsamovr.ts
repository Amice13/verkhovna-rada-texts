...
const START_URL = 'https://komsamovr.rada.gov.ua'
const TRANSCRIPT_URL = `${START_URL}/documents/dijal_komit9skl/stenogrzk9skl`

const NAME = 'Комітет з питань організації державної влади, місцевого самоврядування, регіонального розвитку та містобудування'
const TARGET_PATH = ['.', 'results', 'komsamovr']
